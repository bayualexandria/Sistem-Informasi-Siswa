        ...
        <div class="flex items-center justify-center min-h-full p-4 text-center ">
            <div class="relative overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:max-w-lg sm:w-full">
                <div class="px-5 pt-5">
                    ...
                    <h1 class="text-base font-bold text-slate-500">Tambah Data Guru</h1>
                </div>
                    ...
                    <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                        ...
                        <div class="flex flex-col p-4 modal-body gap-y-2">
                            <div class="flex flex-col w-full gap-y-2">
                                ...
                                <input type="text" id="nip" class="w-full px-3 py-1 text-black border rounded-md bg-slate-100 focus:outline-none focus:ring-1 <?= $validation->hasError('nip') ? 'border-red-500 focus:ring-red-500' : 'border-sky-500 focus:ring-sky-500'; ?> placeholder:text-sm placeholder:font-bold" name="nip" value="<?= old('nip'); ?>" placeholder="910889xxxxxx" />
                                <span class="flex">
                            ...
                            <div class="flex flex-col w-full gap-y-2">
                                ...
                                <input type="text" id="nama" name="nama" class="w-full px-3 py-1 text-black border rounded-md bg-slate-100 focus:outline-none focus:ring-1 <?= $validation->hasError('nama') ? 'border-red-500 focus:ring-red-500' : 'border-sky-500 focus:ring-sky-500'; ?> placeholder:text-sm placeholder:font-bold" name="nama" value="<?= old('nama'); ?>" placeholder="Bagas Eka Prasetyo, S.Kom" />
                                <span class="flex">
                                    <p class="pt-2 font-sans text-xs text-red-500">
                                ...
                                <div class="flex flex-col w-full gap-2 ">
                                    ...
                                    <div class="flex flex-col justify-start md:flex-row gap-x-2">
                                        <div class="flex flex-row gap-x-1">
                                            <input class="w-3.5 h-3.5 mt-1 mr-2 transition duration-200 bg-white bg-center border rounded-full appearance-none cursor-pointer checked:bg-primary checked:border-primary focus:outline-none align-center border-primary" type="radio" name="jenis_kelamin" id="Laki-laki" value="Laki-laki" checked>
                                            <label class="inline-block text-gray-800 form-check-label" for="Laki-laki">Laki-laki</label>
                                        </div>
                                        <div class="flex flex-row gap-x-1">
                                            <input class="w-3.5 h-3.5 mt-1 mr-2 transition duration-200 bg-white bg-center border rounded-full appearance-none cursor-pointer checked:bg-primary checked:border-primary focus:outline-none align-center border-primary" type="radio" name="jenis_kelamin" id="Perempuan" value="Perempuan">
                                ...
                                <div class="flex justify-start">
                                    <div class="w-full mb-3">
                                        ...
                                        <div class="flex flex-row">
                                            <input class="file:rounded-full file:bg-sky-200 file:border-none file:text-sm file:font-bold file:text-primary file:px-4 file:py-1.5 file:cursor-pointer outline-none text-slate-500 text-sm font-bold " type="file" name="image_profile" onchange="addPreviewImage('addImage')" id="addImage" value="<?= old('image_profile'); ?>">
                                        </div>
                                        <span class="flex">
                                            <p class="pt-2 font-sans text-xs text-red-500">

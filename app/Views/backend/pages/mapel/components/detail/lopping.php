    ...
    <table class="w-full divide-y divide-gray-300 table-auto">
        <thead class="bg-gray-50">
            <tr>
                ...
                <th class="px-3 py-[10px] text-sm text-gray-500">Nilai</th>
                            ...
                            <?php foreach ($data as $d) : ?>
                                <td class="px-3 py-[10px]">
                                    <button type="button" data-bs-toggle="modal" id="updateNilaiMapelSiswa<?= $d->id ?>" onclick="showModal('updateNilaiMapelSiswa<?= $d->id ?>')" data-bs-target="#update-nilai<?= $d->id ?>" class="p-2 text-sm font-bold rounded-md shadow-md outline-none text-lime-500 bg-slate-100">
                                        ...
                                        ?>
                                        <?php if ($d->nilai >= 95) : ?>
                                            <p class="text-sm font-bold text-lime-500"><?= $d->nilai; ?></p>
                                        <?php elseif ($d->nilai >= 90) : ?>
                                            <p class="text-sm font-bold text-lime-500"><?= $d->nilai; ?></p>
                                        <?php elseif ($d->nilai >= $bPlus) : ?>
                                            <p class="text-sm font-bold text-sky-500"><?= $d->nilai; ?></p>
                                        <?php elseif ($d->nilai >=  $b) : ?>
                                            <p class="text-sm font-bold text-sky-500"><?= $d->nilai; ?></p>
                                        <?php elseif ($d->nilai >  $nilaiRataRata['nilai_rata_rata']) : ?>
                                            <p class="text-sm font-bold text-orange-500"><?= $d->nilai; ?></p>
                                        <?php elseif ($d->nilai ==  $nilaiRataRata['nilai_rata_rata']) : ?>
                                            <p class="text-sm font-bold text-orange-500"><?= $d->nilai; ?></p>
                                        <?php elseif ($d->nilai <  $nilaiRataRata['nilai_rata_rata']) : ?>
                                            <p class="text-sm font-bold text-rose-500"><?= $d->nilai; ?></p>
                                ...
                                <td class="px-3 py-[10px] text-center ">
                                    ...
                                    ?>
                                    <?php if ($d->nilai >= 95) : ?>
                                        <p class="text-sm font-bold text-lime-500">A+</p>
                                    <?php elseif ($d->nilai >= 90) : ?>
                                        <p class="text-sm font-bold text-lime-500">A</p>
                                    <?php elseif ($d->nilai >= $bPlus) : ?>
                                        <p class="text-sm font-bold text-sky-500">B+</p>
                                    <?php elseif ($d->nilai >=  $b) : ?>
                                        <p class="text-sm font-bold text-sky-500">B</p>
                                    <?php elseif ($d->nilai >  $nilaiRataRata['nilai_rata_rata']) : ?>
                                        <p class="text-sm font-bold text-orange-500">C+</p>
                                    <?php elseif ($d->nilai ==  $nilaiRataRata['nilai_rata_rata']) : ?>
                                        <p class="text-sm font-bold text-orange-500">C</p>
                                    <?php elseif ($d->nilai <  $nilaiRataRata['nilai_rata_rata']) : ?>
                                        <p class="text-sm font-bold text-rose-500">D</p>
                                    <?php endif; ?>

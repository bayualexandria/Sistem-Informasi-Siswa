<div class="relative z-10 hidden" id="addNilaiRataRata" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div class="flex items-center justify-center min-h-full p-4 text-center ">
            <div class="relative overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:max-w-lg sm:w-full">
                <div class="px-5 pt-5">
                    ...
                    <h1 class="text-base font-bold text-slate-500">Nilai Rata Rata</h1>
                </div>
                <form action="<?= base_url('/nilai-rata-rata/' . $mapel->id); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="px-4 py-3 bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse gap-x-2">
                        ...
                        <button type="button" class="px-2 py-1 text-base font-bold text-white transition duration-200 rounded-md bg-slate-500 hover:bg-white hover:text-slate-500 hover:ring-1 hover:ring-slate-300" onclick="showModal('addNilaiRataRataModal')">Batal</button>
                    </div>
                </form>
            </div>
        </div>

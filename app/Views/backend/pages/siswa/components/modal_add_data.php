        ...
        <div class="flex items-center justify-center min-h-full p-4 text-center ">
            <div class="relative overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:max-w-lg sm:w-full">
                <div class="px-5 pt-5">
                    ...
                    <h1 class="text-base font-bold text-slate-500">Tambah Data Siswa</h1>
                </div>
                    ...
                    <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                        ...
                        <div class="flex flex-col p-4 modal-body gap-y-2">
                            <div class="flex flex-col w-full gap-y-2">
                                ...
                                <input type="text" id="no_induk" class="w-full px-3 py-1 text-black border rounded-md bg-slate-100 focus:outline-none focus:ring-1 <?= $validation->hasError('no_induk') ? 'border-red-500 focus:ring-red-500' : 'border-sky-500 focus:ring-sky-500'; ?> placeholder:text-sm placeholder:font-bold" name="no_induk" value="<?= old('no_induk'); ?>" placeholder="818xxx" />
                                <span class="flex">

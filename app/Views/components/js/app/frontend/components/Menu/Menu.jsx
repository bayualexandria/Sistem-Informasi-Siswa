...
if (document.getElementById("frontend-logo-menu")) {
  const item = document.getElementById("frontend-logo-menu");
  ReactDOM.render(<Menu siswa={item.getAttribute("siswa")} />, item);
}

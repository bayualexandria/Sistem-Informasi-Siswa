...
function Login() {
  ...
  return (
    <div className="flex flex-row items-center justify-center h-screen px-10 gap-x-36 bg-slate-100">
      <div className="w-2/4 p-10 bg-white rounded-md shadow-md">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis
        dolorem deserunt reiciendis delectus provident odio quidem nesciunt
        alias nostrum ipsum est consectetur qui aliquam animi rerum eius dicta,
        quae illo saepe natus minus, dignissimos quia dolores nemo! Repellendus,
        explicabo aspernatur deleniti unde, quia at vel ipsam eos, similique
        eius corporis?
      </div>
